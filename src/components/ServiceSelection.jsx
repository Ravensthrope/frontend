      ...
      <div className="bg-green-950 w-full flex gap-y-4 rounded-lg h-fit p-4 text-white justify-center flex-col text-center">
        ...
        <div className="md:max-w-[60%] mx-auto">
          <div className="flex gap-y-2 flex-col">
            ...
            <h4 className="font-bold md:text-2xl text-xl">Choose A Service</h4>
          ...
          <div className="flex flex-col gap-y-2">
            ...
            <h4 className="font-bold md:text-2xl text-xl">Request a Meeting</h4>
            <p className="md:text-xl text-lg">
              Let's sit down and discuss your goals, challenges, and vision.
              We'll explore how our services can align with your objectives and
          ...
          <div className="flex flex-col gap-y-2">
            ...
            <p className="md:text-xl text-lg">
              Based on our discussion, we'll craft a personalized plan designed
              to maximize your growth potential. This custom strategy will
              outline actionable steps tailored to your business, ensuring
              optimal results.
            </p>
          </div>
          <div className="flex flex-col gap-y-2">
            ...
            <p className="md:text-xl text-lg">
              With your custom plan in hand, we'll collaborate closely to bring
              your vision to life. From implementation to execution, we're
              dedicated to turning your ideas into reality and achieving
              tangible results.
            </p>
          </div>
        </div>
